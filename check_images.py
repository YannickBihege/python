...
# PROGRAMMER:    Yannick Bihege
# DATE CREATED:     17.05.18
...
def main():
    # 1. Set the starting time of the application
    start_time = time()
    
    # DONE: 2. Define get_input_args() function to create & retrieve command
    # line arguments. The parameters are passed during the call python---
    in_arg = get_input_args()
    #verify wether the function is working
    print("command line  dir= ", in_arg.dir)
    ...
    print("\n answers_dis has" , len(answers_dic),
...
# Define all the function below. Notice that the input 
...
def get_input_args():
    ...
    To input arguments python script.py --dir pets/  --arch resnet --dogfile dnames.txt
    """
    #Create the parser
    parser = argparse.ArgumentParser()
    #Add 3 commands for each of the argument    parser.add_argument('' ,type= , default="" , help="")
    parser.add_argument('--dir' ,type= str , default="pet/images/")
...
def get_pet_labels(image_dir):
    ...
    Returns:
     petlabels_dic - Dictionary storing image filename (as key) and Pet Image
                     Labels (as value)  
    """
    #retrieve the filename from the directory
